...
int main(int argc, char* argv[])
{
    ...
    try
    {
        ...
        cout << endl << "Client port: " << htons(clnt.sin_port);*/

        Sleep(10000);

        while (lb = recvfrom(sS, ibuf, sizeof(ibuf), NULL, (sockaddr*)&clnt, &lc)) {
            cout << endl << ibuf;
            sendto(sS, ibuf, strlen(ibuf) + 1, NULL, (sockaddr*)&clnt, sizeof(clnt));
        }
