...
namespace Перемежение
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Alternation(masN, k);
            Console.WriteLine("\nКодовое сообщение после перемежения: ");
            OutMas(masN);
            ...
            try
            {
                ...
                Console.WriteLine("Введите длину пакета ошибок");
            ...
            Console.WriteLine("\nКодовое сообщение с ошибками: ");
            OutMas(masN);

            ReAlternation(masN, k);
            Console.WriteLine("\nКодовое сообщение после деперемежения: ");
            OutMas(masN);

            SearchErrorLong(masN, checkMatrix, k);
            Console.WriteLine("\n\nКодовое сообщение после исправления ошибок: ");
            OutMas(masN);

            RemoveCheckBits(masK2, masN, checkMatrix);
            Console.WriteLine("\n\nИнформационное сообщение после удаления проверочных бит: ");
            OutMas(masK2);
            Console.WriteLine("\n\nИсходное информационное сообщение: ");
            OutMas(masK);
            Console.WriteLine("");
