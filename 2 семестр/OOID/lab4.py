...
# вычисление параметров для одномерного набора
...
# параметры наклона (весы, коэффициенты)
...
# построение модели на более сложном наборе данных
...
# гребневая регрессия с разными значениями регуляризации
