...
# синтетический набор wave, непрерывный отклик
...
# реальный набор - рак молочной железы
...
# реальный набор - стоимость домов в нескольких районах Бостона
# прогноз медианной стоимости домов в 1970-е
from sklearn.datasets import load_boston
boston = load_boston()
print("форма массива data для набора boston: {}".format(boston.data.shape))

# конструирование (включение производных признаков, взаимодействие)
X, y = mglearn.datasets.load_extended_boston()
print("форма массива X: {}".format(X.shape))

# метод k ближайших соседей для решения задачи классификации - 1 сосед
...
# поиск взаимосвязи между сложностью модели и обобщающей способностью
from sklearn.datasets import load_breast_cancer
cancer = load_breast_cancer()
...
# регрессионный вариант алгоритма k ближайших соседей
